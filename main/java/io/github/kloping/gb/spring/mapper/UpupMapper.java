...
public interface UpupMapper {
    ...
    Integer select(@Param("qid") String qid, @Param("level") Integer level, @Param("p") Integer p);
    ...
    Integer insert(@Param("qid") String qid, @Param("level") Integer level, @Param("p") Integer p);
    ...
    Integer deleteByQq(@Param("qid") String qid, @Param("p") Integer p);
}
