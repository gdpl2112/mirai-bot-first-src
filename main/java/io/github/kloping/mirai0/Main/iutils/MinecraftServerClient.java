 ...
 */
public class MinecraftServerClient implements Runnable {
    public static ChannelFuture f;
    public static MinecraftServerClient INSTANCE = null;
                    ...
                    public void initChannel(SocketChannel ch) {
                        ch.pipeline().addLast(new ChannelInboundHandlerAdapter() {
                            ...
                            public void channelRead(ChannelHandlerContext ctx, Object msg) {
                                ...
                                MessageUtils.INSTANCE.sendMessageInGroup("mc server: " + dataStr, gid);
                            }
    ...
    public MinecraftServerClient(String ip, int port, long gid) {
        this.ip = ip;
        this.port = port;
        this.gid = gid;
        INSTANCE = this;
    ...
    public MinecraftServerClient(String property, String property1, String property2) {
