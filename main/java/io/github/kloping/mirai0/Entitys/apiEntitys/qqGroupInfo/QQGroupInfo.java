package io.github.kloping.mirai0.Entitys.apiEntitys.qqGroupInfo;
...
public class QQGroupInfo {
    ...
    public Object[] toStrings() {
        ...
        list.add("群名称:\n" + data.getGroupname());
        list.add("群头像:\n" + Tool.pathToImg(data.getGroupimg()));
    ...
    public String toString() {
        ...
        sb.append("群头像:").append(Tool.pathToImg(data.getGroupimg())).append("\n");
        ...
        sb.append("群主头像:").append(Tool.pathToImg(data.getGroupleader().getImg())).append("\n");
        return sb.toString();
    }
}