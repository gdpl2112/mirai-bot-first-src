...
public class Article {
    ...
    public Article setSubt(String subt) {
        this.subt = subt;
        return this;
    }
    ...
    public Article setHasCover(String hasCover) {
    ...
    public Article setContentId(String contentId) {
    ...
    public Article setNextContentId(String nextContentId) {
    ...
    public Article setPrevContentId(String prevContentId) {
    ...
    public Article setCateKey(String cateKey) {
    ...
    public Article setStart_time(String start_time) {
    ...
    public Article setCateId(String cateId) {
        this.cateId = cateId;
        return this;
    }
