...
public class MihoyoP0 {
    ...
    public String[] getNews(String cid) {
        ...
        return new String[]{Tool.INSTANCE.unicodeToCn(pic), title, s};
    }
    ...
    public String getMessageStringYs(Element element) {
        ...
        if (hasVideoTag(element)) {
            ...
            sb.append("相关视频:");
            sb.append(Tool.INSTANCE.unicodeToCn(s1));
        }
        for (Element child : element.children()) {
            ...
            if (hasImgTag(child)) {
                sb.append("\n").append(Tool.INSTANCE.pathToImg(child.getElementsByTag(IMG_TAG_STR).get(0).attr("src")));
            }
        }
        return sb.toString();
    }
