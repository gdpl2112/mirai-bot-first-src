...
import Project.interfaces.httpApi.GetPvpQQ;
        ...
        for (Element e : elements) {
            if (hasImgTag(e)) {
                for (Element img : e.getElementsByTag("img")) {
                    sb.append(MessageUtils.INSTANCE.createImage(BOT.getGroup(gid), img.attr("src"))).append("\n");
                }
            } else {
        ...
        for (Element e : elements) {
            if (hasImgTag(e)) {
                for (Element img : e.getElementsByTag("img")) {
                    ...
                    if (!m0.equals(upS0)) {
                        sb.append(MessageUtils.INSTANCE.createImage(BOT.getGroup(gid), m0)).append("\n");
                    }
                    upS0 = m0;
                }
            } else {
